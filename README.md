...
{
  Lcd_cursor(&lcd, 0, 1);
  Lcd_string(&lcd, "Abrar");

  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212223040111");
}
...
## Output screen shots of proteus  :
 <img width="1078" height="748" alt="image" src="https://github.com/user-attachments/assets/35ca1ced-c724-4a73-8109-def5ad30313e" />

 
 ## CIRCUIT DIAGRAM: 
 <img width="1210" height="849" alt="image" src="https://github.com/user-attachments/assets/d89e6f4c-71ae-4bd6-b3cd-86bd53416a23" />
